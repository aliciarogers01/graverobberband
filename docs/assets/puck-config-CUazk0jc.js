function he(e,t){for(var a=0;a<t.length;a++){const i=t[a];if(typeof i!="string"&&!Array.isArray(i)){for(const o in i)if(o!=="default"&&!(o in e)){const n=Object.getOwnPropertyDescriptor(i,o);n&&Object.defineProperty(e,o,n.get?n:{enumerable:!0,get:()=>i[o]})}}}return Object.freeze(Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}))}(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function a(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=a(o);fetch(o.href,n)}})();function ye(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var re={exports:{}},O={},ae={exports:{}},g={};/**
 * @license React
 ...
 */var E=Symbol.for("react.element"),we=Symbol.for("react.portal"),ke=Symbol.for("react.fragment"),ve=Symbol.for("react.strict_mode"),Ce=Symbol.for("react.profiler"),Se=Symbol.for("react.provider"),ze=Symbol.for("react.context"),$e=Symbol.for("react.forward_ref"),Be=Symbol.for("react.suspense"),Fe=Symbol.for("react.memo"),Te=Symbol.for("react.lazy"),J=Symbol.iterator;function We(e){return e===null||typeof e!="object"?null:(e=J&&e[J]||e["@@iterator"],typeof e=="function"?e:null)}var ie={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},ne=Object.assign,le={};function L(e,t,a){this.props=e,this.context=t,this.refs=le,this.updater=a||ie}L.prototype.isReactComponent={};L.prototype.setState=function(e,t){if(typeof e!="object"&&typeof e!="function"&&e!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,e,t,"setState")};L.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};function de(){}de.prototype=L.prototype;function _(e,t,a){this.props=e,this.context=t,this.refs=le,this.updater=a||ie}var X=_.prototype=new de;X.constructor=_;ne(X,L.prototype);X.isPureReactComponent=!0;var K=Array.isArray,se=Object.prototype.hasOwnProperty,V={current:null},pe={key:!0,ref:!0,__self:!0,__source:!0};function ce(e,t,a){var i,o={},n=null,l=null;if(t!=null)for(i in t.ref!==void 0&&(l=t.ref),t.key!==void 0&&(n=""+t.key),t)se.call(t,i)&&!pe.hasOwnProperty(i)&&(o[i]=t[i]);var s=arguments.length-2;if(s===1)o.children=a;else if(1<s){for(var c=Array(s),m=0;m<s;m++)c[m]=arguments[m+2];o.children=c}if(e&&e.defaultProps)for(i in s=e.defaultProps,s)o[i]===void 0&&(o[i]=s[i]);return{$$typeof:E,type:e,key:n,ref:l,props:o,_owner:V.current}}function je(e,t){return{$$typeof:E,type:e.type,key:t,ref:e.ref,props:e.props,_owner:e._owner}}function q(e){return typeof e=="object"&&e!==null&&e.$$typeof===E}function Le(e){var t={"=":"=0",":":"=2"};return"$"+e.replace(/[=:]/g,function(a){return t[a]})}var Q=/\/+/g;function D(e,t){return typeof e=="object"&&e!==null&&e.key!=null?Le(""+e.key):t.toString(36)}function U(e,t,a,i,o){var n=typeof e;(n==="undefined"||n==="boolean")&&(e=null);var l=!1;if(e===null)l=!0;else switch(n){case"string":case"number":l=!0;break;case"object":switch(e.$$typeof){case E:case we:l=!0}}if(l)return l=e,o=o(l),e=i===""?"."+D(l,0):i,K(o)?(a="",e!=null&&(a=e.replace(Q,"$&/")+"/"),U(o,t,a,"",function(m){return m})):o!=null&&(q(o)&&(o=je(o,a+(!o.key||l&&l.key===o.key?"":(""+o.key).replace(Q,"$&/")+"/")+e)),t.push(o)),1;if(l=0,i=i===""?".":i+":",K(e))for(var s=0;s<e.length;s++){n=e[s];var c=i+D(n,s);l+=U(n,t,a,c,o)}else if(c=We(e),typeof c=="function")for(e=c.call(e),s=0;!(n=e.next()).done;)n=n.value,c=i+D(n,s++),l+=U(n,t,a,c,o);else if(n==="object")throw t=String(e),Error("Objects are not valid as a React child (found: "+(t==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":t)+"). If you meant to render a collection of children, use an array instead.");return l}function A(e,t,a){if(e==null)return e;var i=[],o=0;return U(e,i,"","",function(n){return t.call(a,n,o++)}),i}function Pe(e){if(e._status===-1){var t=e._result;t=t(),t.then(function(a){(e._status===0||e._status===-1)&&(e._status=1,e._result=a)},function(a){(e._status===0||e._status===-1)&&(e._status=2,e._result=a)}),e._status===-1&&(e._status=0,e._result=t)}if(e._status===1)return e._result.default;throw e._result}var x={current:null},N={transition:null},Re={ReactCurrentDispatcher:x,ReactCurrentBatchConfig:N,ReactCurrentOwner:V};g.Children={map:A,forEach:function(e,t,a){A(e,function(){t.apply(this,arguments)},a)},count:function(e){var t=0;return A(e,function(){t++}),t},toArray:function(e){return A(e,function(t){return t})||[]},only:function(e){if(!q(e))throw Error("React.Children.only expected to receive a single React element child.");return e}};g.Component=L;g.Fragment=ke;g.Profiler=Ce;g.PureComponent=_;g.StrictMode=ve;g.Suspense=Be;g.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Re;g.cloneElement=function(e,t,a){if(e==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+e+".");var i=ne({},e.props),o=e.key,n=e.ref,l=e._owner;if(t!=null){if(t.ref!==void 0&&(n=t.ref,l=V.current),t.key!==void 0&&(o=""+t.key),e.type&&e.type.defaultProps)var s=e.type.defaultProps;for(c in t)se.call(t,c)&&!pe.hasOwnProperty(c)&&(i[c]=t[c]===void 0&&s!==void 0?s[c]:t[c])}var c=arguments.length-2;if(c===1)i.children=a;else if(1<c){s=Array(c);for(var m=0;m<c;m++)s[m]=arguments[m+2];i.children=s}return{$$typeof:E,type:e.type,key:o,ref:n,props:i,_owner:l}};g.createContext=function(e){return e={$$typeof:ze,_currentValue:e,_currentValue2:e,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},e.Provider={$$typeof:Se,_context:e},e.Consumer=e};g.createElement=ce;g.createFactory=function(e){var t=ce.bind(null,e);return t.type=e,t};g.createRef=function(){return{current:null}};g.forwardRef=function(e){return{$$typeof:$e,render:e}};g.isValidElement=q;g.lazy=function(e){return{$$typeof:Te,_payload:{_status:-1,_result:e},_init:Pe}};g.memo=function(e,t){return{$$typeof:Fe,type:e,compare:t===void 0?null:t}};g.startTransition=function(e){var t=N.transition;N.transition={};try{e()}finally{N.transition=t}};g.unstable_act=function(){throw Error("act(...) is not supported in production builds of React.")};g.useCallback=function(e,t){return x.current.useCallback(e,t)};g.useContext=function(e){return x.current.useContext(e)};g.useDebugValue=function(){};g.useDeferredValue=function(e){return x.current.useDeferredValue(e)};g.useEffect=function(e,t){return x.current.useEffect(e,t)};g.useId=function(){return x.current.useId()};g.useImperativeHandle=function(e,t,a){return x.current.useImperativeHandle(e,t,a)};g.useInsertionEffect=function(e,t){return x.current.useInsertionEffect(e,t)};g.useLayoutEffect=function(e,t){return x.current.useLayoutEffect(e,t)};g.useMemo=function(e,t){return x.current.useMemo(e,t)};g.useReducer=function(e,t,a){return x.current.useReducer(e,t,a)};g.useRef=function(e){return x.current.useRef(e)};g.useState=function(e){return x.current.useState(e)};g.useSyncExternalStore=function(e,t,a){return x.current.useSyncExternalStore(e,t,a)};g.useTransition=function(){return x.current.useTransition()};g.version="18.2.0";ae.exports=g;var I=ae.exports;const ge=ye(I),wt=he({__proto__:null,default:ge},[I]);/**
 * @license React
...
`}function De(e){return z(e.fontUrl)}function Ye(e){const t=(e.buttons||[]).map(P).join("");return`<header class="puck-site-header ${e.headerPosition==="full"?"is-full-width":""}" style="${b({background:e.backgroundColor||"rgba(0,0,0,.72)",borderBottom:e.lineColor?`1px solid ${e.lineColor}`:"none",boxShadow:e.lineShadow||"none",width:e.width||"100%",maxWidth:e.maxWidth||"none",margin:e.margin||"0",padding:e.padding||"22px 40px"})}">
  ...
  <section
    ...
    style="${b({background:e.backgroundColor||"transparent",padding:`${e.paddingY||70}px ${e.paddingX||24}px`})}"
  >
    ...
    >
      ...
      <div class="gr-welcome-content">
        ${f(e.eyebrow)?`<p class="gr-welcome-eyebrow">${u(e.eyebrow)}</p>`:""}

        ${f(e.title)?`<h2 class="gr-welcome-title">${u(e.title)}</h2>`:""}

        ${f(e.body)?`<p class="gr-welcome-body">${H(e.body)}</p>`:""}
  ...
  <\/script>`}function Z(e){const t=b({background:e.backgroundColor||"transparent",color:e.textColor||"inherit",padding:`${e.paddingY||70}px ${e.paddingX||24}px`}),a=b({width:e.imageWidth||"320px","--mobile-image-width":e.mobileImageWidth||e.imageWidth||"320px",borderRadius:e.imageRadius||"8px",boxShadow:e.imageShadow||"none"}),i=f(e.title)?`<h1 class="band-name puck-title" style="${b(S(e,"title"))}">${u(e.title)}</h1>`:"",o=f(e.subtitle)?`<p class="tagline puck-subtitle" style="${b(S(e,"subtitle"))}">${u(e.subtitle)}</p>`:"",n=f(e.body)?`<p class="description puck-body" style="${b(S(e,"body"))}">${H(e.body)}</p>`:"",l=(e.buttons||[]).map(P).join(""),s=i||o||n||l?`<div class="puck-text">${i}${o}${n}${l?`<div class="puck-buttons">${l}</div>`:""}</div>`:"",c=e.imageUrl?`<img class="puck-image puck-mobile-sized-image" src="${p(e.imageUrl)}" alt="${p(e.imageAlt||e.title||"Image")}" style="${a}">`:"";return`${z(e.customFontUrl)}<section class="puck-section" style="${t}"><div class="puck-inner puck-flex layout-${p(e.layout||"text-left")}" style="--gap:${Number(e.gap||50)}px;--max-width:${p(e.maxWidth||"1100px")}">${s}${c}</div></section>`}function Ve(e){const t=e.align||"center",a=b({background:e.backgroundColor||"transparent",color:e.textColor||"inherit",padding:`${e.paddingY||50}px ${e.paddingX||24}px`,textAlign:t}),i=f(e.eyebrow)?`<p class="teaser" style="${b(S(e,"eyebrow"))}">${u(e.eyebrow)}</p>`:"",o=f(e.title)?`<h2 class="puck-title" style="${b(S(e,"title"))}">${u(e.title)}</h2>`:"",n=f(e.body)?`<p class="puck-body" style="${b(S(e,"body"))}">${H(e.body)}</p>`:"",l=(e.buttons||[]).map(P).join("");return`${z(e.customFontUrl)}<section class="puck-section" style="${a}"><div class="puck-inner puck-text" style="max-width:${p(e.maxWidth||"850px")}">${i}${o}${n}${l?`<div class="puck-buttons">${l}</div>`:""}</div></section>`}function ee(e){const t=b({background:e.backgroundColor||"transparent",padding:`${e.paddingY||40}px ${e.paddingX||24}px`,textAlign:e.align||"center"}),a=b({width:e.width||"900px","--mobile-image-width":e.mobileWidth||e.width||"900px",borderRadius:e.radius||"8px",boxShadow:e.shadow||"none"}),i=f(e.title)?`<h2 class="puck-title" style="${b(S(e,"title"))}">${u(e.title)}</h2>`:"",o=e.imageUrl?`<img class="puck-image puck-mobile-sized-image" src="${p(e.imageUrl)}" alt="${p(e.imageAlt||e.title||"Image")}" style="${a}">`:"";return`${z(e.customFontUrl)}<section class="puck-section" style="${t}"><div class="puck-inner" style="max-width:${p(e.maxWidth||"1100px")}">${i}${o}</div></section>`}function qe(e){const t=b({background:e.backgroundColor||"transparent",color:e.textColor||"inherit",padding:`${e.paddingY||50}px ${e.paddingX||24}px`,textAlign:"center"}),a=(e.buttons||[]).map(P).join("");return a?`${z(e.customFontUrl)}<section class="puck-section" style="${t}"><div class="puck-inner"><div class="puck-buttons">${a}</div></div></section>`:""}function te(e){const t=b({background:e.backgroundColor||"transparent",color:e.textColor||"inherit",padding:`${e.paddingY||60}px ${e.paddingX||24}px`,textAlign:"center"}),a=e.links||[],i=f(e.title)?`<p class="teaser" style="${b({color:e.titleColor||"inherit",fontFamily:e.titleFont||"inherit",fontSize:e.titleSize||"inherit",fontWeight:e.titleWeight||"inherit"})}">${u(e.title)}</p>`:"",o=a.filter(n=>f(n.url)).map(n=>`<a class="social-link" href="${p(n.url)}" target="_blank" rel="noopener noreferrer" title="${p(n.label||n.platform)}" style="${b({background:n.backgroundColor||"rgba(255,255,255,.03)",color:n.iconColor||"inherit",border:`${n.borderWidth||"1px"} solid ${n.borderColor||"rgba(255,255,255,.18)"}`,boxShadow:n.boxShadow||"none",borderRadius:n.radius||"999px",width:n.size||"44px",height:n.size||"44px",minWidth:n.size||"44px",minHeight:n.size||"44px",padding:n.padding||"0px","--social-svg-size":n.svgSize||"22px"})}">${Oe(n.platform,n.label)}</a>`).join("");return!i&&!o?"":`<footer class="puck-section social-section is-full-width" style="${t}"><div class="puck-inner">${i}${o?`<nav class="puck-social-links social-links">${o}</nav>`:""}</div></footer>`}function Je(e){const t=b({background:e.backgroundColor||"transparent",color:e.textColor||"inherit",padding:`${e.paddingY||40}px ${e.paddingX||24}px`,textAlign:"center"}),a=f(e.title)?`<h2 class="puck-title" style="${b({color:e.titleColor||"inherit",fontFamily:e.titleFont||"inherit",fontSize:e.titleSize||"2.5rem"})}">${u(e.title)}</h2>`:"",i=(e.images||[]).filter(o=>f(o.imageUrl)).map((o,n)=>{const l=`gallery-modal-${n}`;return`
        <figure class="puck-gallery-item">
          <a href="#${l}" class="puck-gallery-open">
            <img src="${p(o.imageUrl)}" alt="${p(o.imageAlt||"Gallery image")}">
          </a>
          ${f(o.caption)?`<figcaption>${u(o.caption)}</figcaption>`:""}
        </figure>

        <div id="${l}" class="puck-gallery-modal">
      ...
      `}).join("");return`<section class="puck-section" style="${t}"><div class="puck-inner">${a}<div class="puck-gallery-grid" style="--cols:${Number(e.columns||3)};--gap:${Number(e.gap||18)}px">${i}</div></div></section>`}function Ke(e){return`<div class="puck-spacer" style="height:${Number(e.height||40)}px;background:${p(e.backgroundColor||"transparent")}"></div>`}function Qe(e){const t=b({background:e.backgroundColor||"transparent",color:e.textColor||"inherit",padding:`${e.paddingY||50}px ${e.paddingX||24}px`}),i=(e.items||[]).map(o=>{const n=o.imageUrl?`<img class="puck-image" src="${p(o.imageUrl)}" alt="${p(o.title||"Column image")}" style="width:100%;border-radius:${p(e.imageRadius||"8px")};margin-bottom:16px;">`:"",l=f(o.title)?`<h3 style="${b({color:o.titleColor||"inherit",fontFamily:o.titleFont||"inherit",fontSize:o.titleSize||"inherit",fontWeight:o.titleWeight||"inherit"})}">${u(o.title)}</h3>`:"",s=f(o.body)?`<p style="${b({color:o.bodyColor||"inherit",fontFamily:o.bodyFont||"inherit",fontSize:o.bodySize||"inherit",fontWeight:o.bodyWeight||"inherit"})}">${H(o.body)}</p>`:"",c=P({text:o.buttonText,url:o.buttonUrl,backgroundColor:o.buttonBackgroundColor,textColor:o.buttonTextColor,fontFamily:o.buttonFont,fontSize:o.buttonFontSize,borderWidth:o.buttonBorderWidth,borderColor:o.buttonBorderColor,radius:o.buttonRadius,boxShadow:o.buttonBoxShadow,textTransform:o.buttonTextTransform});return n||l||s||c?`<div class="puck-card">${n}${l}${s}${c}</div>`:""}).join("");return i?`${z(e.customFontUrl)}<section class="puck-section" style="${t}"><div class="puck-inner"><div class="puck-columns" style="--cols:${Number(e.columns||2)};--gap:${Number(e.gap||24)}px">${i}</div></div></section>`:""}function Ze(e){const t=b({background:e.backgroundColor||"#000000",padding:`${e.paddingY||30}px ${e.paddingX||24}px ${e.paddingBottom||80}px`}),a=e.formAction||"https://docs.google.com/forms/d/e/1FAIpQLSc75dAf3CXeOinDkL-URjVql6_o3E2PcXKPhB3j-mFnl0JBMw/formResponse",i=e.nameEntry||"entry.821607845",o=e.emailEntry||"entry.216699627",n=e.phoneEntry||"entry.1566132030",l=e.zipEntry||"entry.848273318",s=e.successMessage||"Great, you are signed up and we will keep you updated.";return`<section class="puck-section graverobber-contact-form-section graverobber-signup-form-section" style="${t}">
    <div class="puck-inner graverobber-contact-inner">
      <form class="graverobber-custom-contact-form" action="${p(a)}" method="POST" target="graverobber-signup-hidden-frame" onsubmit="setTimeout(() => { this.reset(); this.querySelector('.graverobber-contact-success').textContent='${p(s)}'; }, 350);">
        ...
        <label>
          ...
          <input type="email" name="${p(o)}" required>
        </label>
  ...
  </section>`}function et(e){const t=b({background:e.backgroundColor||"#000000",padding:`${e.paddingY||30}px ${e.paddingX||24}px ${e.paddingBottom||80}px`}),a=e.formAction||"https://docs.google.com/forms/d/e/1FAIpQLSfvFy-I4z36zqLz4y4boVhM4eTL7KEb5Ip1It7OZyFfxlRgMw/formResponse",i=e.nameEntry||"entry.111991046",o=e.emailEntry||"entry.709491702",n=e.messageEntry||"entry.905150677",l=e.successMessage||"Great, your message was sent and we will get back to you shortly.";return`<section class="puck-section graverobber-contact-form-section" style="${t}">
    <div class="puck-inner graverobber-contact-inner">
      <form class="graverobber-custom-contact-form" action="${p(a)}" method="POST" target="graverobber-contact-hidden-frame" onsubmit="setTimeout(() => { this.reset(); this.querySelector('.graverobber-contact-success').textContent='${p(l)}'; }, 350);">
        <label>
          ${u(e.nameLabel||"What are you called?")}
          <input type="text" name="${p(i)}" required>
        </label>
...
`;export{ge as R,wt as a,Y as b,xt as c,kt as d,He as e,mt as f,ye as g,ue as h,r as j,vt as p,I as r};
