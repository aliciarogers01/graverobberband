function he(e,t){for(var r=0;r<t.length;r++){const l=t[r];if(typeof l!="string"&&!Array.isArray(l)){for(const o in l)if(o!=="default"&&!(o in e)){const i=Object.getOwnPropertyDescriptor(l,o);i&&Object.defineProperty(e,o,i.get?i:{enumerable:!0,get:()=>l[o]})}}}return Object.freeze(Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}))}(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))l(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&l(n)}).observe(document,{childList:!0,subtree:!0});function r(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function l(o){if(o.ep)return;o.ep=!0;const i=r(o);fetch(o.href,i)}})();function ye(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var re={exports:{}},M={},ae={exports:{}},s={};/**
 * @license React
 ...
 */var L=Symbol.for("react.element"),ke=Symbol.for("react.portal"),we=Symbol.for("react.fragment"),Ce=Symbol.for("react.strict_mode"),ve=Symbol.for("react.profiler"),Se=Symbol.for("react.provider"),$e=Symbol.for("react.context"),ze=Symbol.for("react.forward_ref"),Be=Symbol.for("react.suspense"),Te=Symbol.for("react.memo"),Fe=Symbol.for("react.lazy"),q=Symbol.iterator;function je(e){return e===null||typeof e!="object"?null:(e=q&&e[q]||e["@@iterator"],typeof e=="function"?e:null)}var le={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},ie=Object.assign,ne={};function B(e,t,r){this.props=e,this.context=t,this.refs=ne,this.updater=r||le}B.prototype.isReactComponent={};B.prototype.setState=function(e,t){if(typeof e!="object"&&typeof e!="function"&&e!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,e,t,"setState")};B.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};function de(){}de.prototype=B.prototype;function _(e,t,r){this.props=e,this.context=t,this.refs=ne,this.updater=r||le}var D=_.prototype=new de;D.constructor=_;ie(D,B.prototype);D.isPureReactComponent=!0;var K=Array.isArray,se=Object.prototype.hasOwnProperty,X={current:null},ce={key:!0,ref:!0,__self:!0,__source:!0};function pe(e,t,r){var l,o={},i=null,n=null;if(t!=null)for(l in t.ref!==void 0&&(n=t.ref),t.key!==void 0&&(i=""+t.key),t)se.call(t,l)&&!ce.hasOwnProperty(l)&&(o[l]=t[l]);var c=arguments.length-2;if(c===1)o.children=r;else if(1<c){for(var p=Array(c),b=0;b<c;b++)p[b]=arguments[b+2];o.children=p}if(e&&e.defaultProps)for(l in c=e.defaultProps,c)o[l]===void 0&&(o[l]=c[l]);return{$$typeof:L,type:e,key:i,ref:n,props:o,_owner:X.current}}function We(e,t){return{$$typeof:L,type:e.type,key:t,ref:e.ref,props:e.props,_owner:e._owner}}function Y(e){return typeof e=="object"&&e!==null&&e.$$typeof===L}function Re(e){var t={"=":"=0",":":"=2"};return"$"+e.replace(/[=:]/g,function(r){return t[r]})}var Q=/\/+/g;function O(e,t){return typeof e=="object"&&e!==null&&e.key!=null?Re(""+e.key):t.toString(36)}function N(e,t,r,l,o){var i=typeof e;(i==="undefined"||i==="boolean")&&(e=null);var n=!1;if(e===null)n=!0;else switch(i){case"string":case"number":n=!0;break;case"object":switch(e.$$typeof){case L:case ke:n=!0}}if(n)return n=e,o=o(n),e=l===""?"."+O(n,0):l,K(o)?(r="",e!=null&&(r=e.replace(Q,"$&/")+"/"),N(o,t,r,"",function(b){return b})):o!=null&&(Y(o)&&(o=We(o,r+(!o.key||n&&n.key===o.key?"":(""+o.key).replace(Q,"$&/")+"/")+e)),t.push(o)),1;if(n=0,l=l===""?".":l+":",K(e))for(var c=0;c<e.length;c++){i=e[c];var p=l+O(i,c);n+=N(i,t,r,p,o)}else if(p=je(e),typeof p=="function")for(e=p.call(e),c=0;!(i=e.next()).done;)i=i.value,p=l+O(i,c++),n+=N(i,t,r,p,o);else if(i==="object")throw t=String(e),Error("Objects are not valid as a React child (found: "+(t==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":t)+"). If you meant to render a collection of children, use an array instead.");return n}function A(e,t,r){if(e==null)return e;var l=[],o=0;return N(e,l,"","",function(i){return t.call(r,i,o++)}),l}function Pe(e){if(e._status===-1){var t=e._result;t=t(),t.then(function(r){(e._status===0||e._status===-1)&&(e._status=1,e._result=r)},function(r){(e._status===0||e._status===-1)&&(e._status=2,e._result=r)}),e._status===-1&&(e._status=0,e._result=t)}if(e._status===1)return e._result.default;throw e._result}var x={current:null},H={transition:null},Le={ReactCurrentDispatcher:x,ReactCurrentBatchConfig:H,ReactCurrentOwner:X};s.Children={map:A,forEach:function(e,t,r){A(e,function(){t.apply(this,arguments)},r)},count:function(e){var t=0;return A(e,function(){t++}),t},toArray:function(e){return A(e,function(t){return t})||[]},only:function(e){if(!Y(e))throw Error("React.Children.only expected to receive a single React element child.");return e}};s.Component=B;s.Fragment=we;s.Profiler=ve;s.PureComponent=_;s.StrictMode=Ce;s.Suspense=Be;s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Le;s.cloneElement=function(e,t,r){if(e==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+e+".");var l=ie({},e.props),o=e.key,i=e.ref,n=e._owner;if(t!=null){if(t.ref!==void 0&&(i=t.ref,n=X.current),t.key!==void 0&&(o=""+t.key),e.type&&e.type.defaultProps)var c=e.type.defaultProps;for(p in t)se.call(t,p)&&!ce.hasOwnProperty(p)&&(l[p]=t[p]===void 0&&c!==void 0?c[p]:t[p])}var p=arguments.length-2;if(p===1)l.children=r;else if(1<p){c=Array(p);for(var b=0;b<p;b++)c[b]=arguments[b+2];l.children=c}return{$$typeof:L,type:e.type,key:o,ref:i,props:l,_owner:n}};s.createContext=function(e){return e={$$typeof:$e,_currentValue:e,_currentValue2:e,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},e.Provider={$$typeof:Se,_context:e},e.Consumer=e};s.createElement=pe;s.createFactory=function(e){var t=pe.bind(null,e);return t.type=e,t};s.createRef=function(){return{current:null}};s.forwardRef=function(e){return{$$typeof:ze,render:e}};s.isValidElement=Y;s.lazy=function(e){return{$$typeof:Fe,_payload:{_status:-1,_result:e},_init:Pe}};s.memo=function(e,t){return{$$typeof:Te,type:e,compare:t===void 0?null:t}};s.startTransition=function(e){var t=H.transition;H.transition={};try{e()}finally{H.transition=t}};s.unstable_act=function(){throw Error("act(...) is not supported in production builds of React.")};s.useCallback=function(e,t){return x.current.useCallback(e,t)};s.useContext=function(e){return x.current.useContext(e)};s.useDebugValue=function(){};s.useDeferredValue=function(e){return x.current.useDeferredValue(e)};s.useEffect=function(e,t){return x.current.useEffect(e,t)};s.useId=function(){return x.current.useId()};s.useImperativeHandle=function(e,t,r){return x.current.useImperativeHandle(e,t,r)};s.useInsertionEffect=function(e,t){return x.current.useInsertionEffect(e,t)};s.useLayoutEffect=function(e,t){return x.current.useLayoutEffect(e,t)};s.useMemo=function(e,t){return x.current.useMemo(e,t)};s.useReducer=function(e,t,r){return x.current.useReducer(e,t,r)};s.useRef=function(e){return x.current.useRef(e)};s.useState=function(e){return x.current.useState(e)};s.useSyncExternalStore=function(e,t,r){return x.current.useSyncExternalStore(e,t,r)};s.useTransition=function(){return x.current.useTransition()};s.version="18.2.0";ae.exports=s;var V=ae.exports;const ue=ye(V),bt=he({__proto__:null,default:ue},[V]);/**
 * @license React
...
`}function _e(e){return T(e.fontUrl)}function De(e){const t=(e.buttons||[]).map(U).join("");return`<header class="puck-site-header ${e.headerPosition==="full"?"is-full-width":""}" style="${g({background:e.backgroundColor||"rgba(0,0,0,.72)",borderBottom:e.lineColor?`1px solid ${e.lineColor}`:"none",boxShadow:e.lineShadow||"none",width:e.width||"100%",maxWidth:e.maxWidth||"none",margin:e.margin||"0",padding:e.padding||"22px 40px"})}">
    <div class="puck-header-left">
      ${e.logoUrl&&e.logoPlacement!=="right"?`<a class="puck-header-logo-link logo-left" href="index.html" style="--logo-size:${u(e.logoSize||"45px")}"><img class="puck-header-logo" src="${u(e.logoUrl)}" alt="${u(e.logoAlt||"Logo")}"></a>`:""}
      ${e.showBack!=="hide"?`<a class="puck-header-back" href="${u(e.backUrl||"index.html")}">${m(e.backText||"Back")}</a>`:""}
    </div>
    <nav class="puck-header-nav nav-${u(e.navPlacement||"right")}">${t}</nav>
    <div class="puck-header-right">
      ${e.logoUrl&&e.logoPlacement==="right"?`<a class="puck-header-logo-link logo-right" href="index.html" style="--logo-size:${u(e.logoSize||"45px")}"><img class="puck-header-logo" src="${u(e.logoUrl)}" alt="${u(e.logoAlt||"Logo")}"></a>`:""}
    </div>
  </header>`}function Xe(e){const t=e.items||[],r=[...t,...t].map(l=>`<span class="song-name" style="${g({color:e.textColor||"var(--cream)",textShadow:e.textShadow||"none",borderColor:e.buttonBorderColor||"rgba(212, 162, 76, 0.25)"})}">${m(l.text)}</span>`).join("");return`<section class="songs-section puck-song-scroll ${e.stretchMode==="full"?"is-full-width":""}" aria-label="Songs We Play" style="${g({background:e.backgroundColor||"linear-gradient(90deg, var(--blue-deep) 0%, var(--charcoal-light) 50%, var(--blue-deep) 100%)",borderBottom:e.lineColor?`1px solid ${e.lineColor}`:"none",width:e.width||"100%",maxWidth:e.maxWidth||"none",margin:e.margin||"0"})}"><div class="songs-scroll-container"><div class="songs-scroll puck-song-track">${r}</div></div></section>`}function Z(e){const t=g({background:e.backgroundColor||"transparent",color:e.textColor||"inherit",padding:`${e.paddingY||70}px ${e.paddingX||24}px`}),r=g({width:e.imageWidth||"320px","--mobile-image-width":e.mobileImageWidth||e.imageWidth||"320px",borderRadius:e.imageRadius||"8px",boxShadow:e.imageShadow||"none"}),l=f(e.title)?`<h1 class="band-name puck-title" style="${g(S(e,"title"))}">${m(e.title)}</h1>`:"",o=f(e.subtitle)?`<p class="tagline puck-subtitle" style="${g(S(e,"subtitle"))}">${m(e.subtitle)}</p>`:"",i=f(e.body)?`<p class="description puck-body" style="${g(S(e,"body"))}">${J(e.body)}</p>`:"",n=(e.buttons||[]).map(U).join(""),c=l||o||i||n?`<div class="puck-text">${l}${o}${i}${n?`<div class="puck-buttons">${n}</div>`:""}</div>`:"",p=e.imageUrl?`<img class="puck-image puck-mobile-sized-image" src="${u(e.imageUrl)}" alt="${u(e.imageAlt||e.title||"Image")}" style="${r}">`:"";return`${T(e.customFontUrl)}<section class="puck-section" style="${t}"><div class="puck-inner puck-flex layout-${u(e.layout||"text-left")}" style="--gap:${Number(e.gap||50)}px;--max-width:${u(e.maxWidth||"1100px")}">${c}${p}</div></section>`}function Ye(e){const t=e.align||"center",r=g({background:e.backgroundColor||"transparent",color:e.textColor||"inherit",padding:`${e.paddingY||50}px ${e.paddingX||24}px`,textAlign:t}),l=f(e.eyebrow)?`<p class="teaser" style="${g(S(e,"eyebrow"))}">${m(e.eyebrow)}</p>`:"",o=f(e.title)?`<h2 class="puck-title" style="${g(S(e,"title"))}">${m(e.title)}</h2>`:"",i=f(e.body)?`<p class="puck-body" style="${g(S(e,"body"))}">${J(e.body)}</p>`:"",n=(e.buttons||[]).map(U).join("");return`${T(e.customFontUrl)}<section class="puck-section" style="${r}"><div class="puck-inner puck-text" style="max-width:${u(e.maxWidth||"850px")}">${l}${o}${i}${n?`<div class="puck-buttons">${n}</div>`:""}</div></section>`}function ee(e){const t=g({background:e.backgroundColor||"transparent",padding:`${e.paddingY||40}px ${e.paddingX||24}px`,textAlign:e.align||"center"}),r=g({width:e.width||"900px","--mobile-image-width":e.mobileWidth||e.width||"900px",borderRadius:e.radius||"8px",boxShadow:e.shadow||"none"}),l=f(e.title)?`<h2 class="puck-title" style="${g(S(e,"title"))}">${m(e.title)}</h2>`:"",o=e.imageUrl?`<img class="puck-image puck-mobile-sized-image" src="${u(e.imageUrl)}" alt="${u(e.imageAlt||e.title||"Image")}" style="${r}">`:"";return`${T(e.customFontUrl)}<section class="puck-section" style="${t}"><div class="puck-inner" style="max-width:${u(e.maxWidth||"1100px")}">${l}${o}</div></section>`}function Ve(e){const t=g({background:e.backgroundColor||"transparent",color:e.textColor||"inherit",padding:`${e.paddingY||50}px ${e.paddingX||24}px`,textAlign:"center"}),r=(e.buttons||[]).map(U).join("");return r?`${T(e.customFontUrl)}<section class="puck-section" style="${t}"><div class="puck-inner"><div class="puck-buttons">${r}</div></div></section>`:""}function te(e){const t=g({background:e.backgroundColor||"transparent",color:e.textColor||"inherit",padding:`${e.paddingY||60}px ${e.paddingX||24}px`,textAlign:"center"}),r=e.links||[],l=f(e.title)?`<p class="teaser" style="${g({color:e.titleColor||"inherit",fontFamily:e.titleFont||"inherit",fontSize:e.titleSize||"inherit",fontWeight:e.titleWeight||"inherit"})}">${m(e.title)}</p>`:"",o=r.filter(i=>f(i.url)).map(i=>`<a class="social-link" href="${u(i.url)}" target="_blank" rel="noopener noreferrer" title="${u(i.label||i.platform)}" style="${g({background:i.backgroundColor||"rgba(255,255,255,.03)",color:i.iconColor||"inherit",borderColor:i.borderColor||"rgba(255,255,255,.18)"})}">${Oe(i.platform,i.label)}</a>`).join("");return!l&&!o?"":`<footer class="puck-section social-section is-full-width" style="${t}"><div class="puck-inner">${l}${o?`<nav class="puck-social-links social-links">${o}</nav>`:""}</div></footer>`}function Je(e){const t=g({background:e.backgroundColor||"transparent",color:e.textColor||"inherit",padding:`${e.paddingY||40}px ${e.paddingX||24}px`,textAlign:"center"}),r=f(e.title)?`<h2 class="puck-title" style="${g({color:e.titleColor||"inherit",fontFamily:e.titleFont||"inherit",fontSize:e.titleSize||"2.5rem"})}">${m(e.title)}</h2>`:"",l=(e.images||[]).filter(o=>f(o.imageUrl)).map((o,i)=>{const n=`gallery-modal-${i}`;return`
        <figure class="puck-gallery-item">
          <a href="#${n}" class="puck-gallery-open">
            <img src="${u(o.imageUrl)}" alt="${u(o.imageAlt||"Gallery image")}">
          </a>
          ${f(o.caption)?`<figcaption>${m(o.caption)}</figcaption>`:""}
        </figure>
...
`;export{ue as R,bt as a,E as b,ut as c,ft as d,Ee as e,ct as f,ye as g,be as h,a as j,mt as p,V as r};
