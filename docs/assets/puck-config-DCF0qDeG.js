 ...
 */var N=Symbol.for("react.element"),ze=Symbol.for("react.portal"),$e=Symbol.for("react.fragment"),Be=Symbol.for("react.strict_mode"),Te=Symbol.for("react.profiler"),Fe=Symbol.for("react.provider"),je=Symbol.for("react.context"),Le=Symbol.for("react.forward_ref"),We=Symbol.for("react.suspense"),Pe=Symbol.for("react.memo"),Re=Symbol.for("react.lazy"),ee=Symbol.iterator;function Ie(e){return e===null||typeof e!="object"?null:(e=ee&&e[ee]||e["@@iterator"],typeof e=="function"?e:null)}var se={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},ce=Object.assign,pe={};function W(e,t,a){this.props=e,this.context=t,this.refs=pe,this.updater=a||se}W.prototype.isReactComponent={};W.prototype.setState=function(e,t){if(typeof e!="object"&&typeof e!="function"&&e!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,e,t,"setState")};W.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};function ge(){}ge.prototype=W.prototype;function J(e,t,a){this.props=e,this.context=t,this.refs=pe,this.updater=a||se}var K=J.prototype=new ge;K.constructor=J;ce(K,W.prototype);K.isPureReactComponent=!0;var te=Array.isArray,be=Object.prototype.hasOwnProperty,Q={current:null},ue={key:!0,ref:!0,__self:!0,__source:!0};function fe(e,t,a){var i,r={},l=null,d=null;if(t!=null)for(i in t.ref!==void 0&&(d=t.ref),t.key!==void 0&&(l=""+t.key),t)be.call(t,i)&&!ue.hasOwnProperty(i)&&(r[i]=t[i]);var p=arguments.length-2;if(p===1)r.children=a;else if(1<p){for(var s=Array(p),f=0;f<p;f++)s[f]=arguments[f+2];r.children=s}if(e&&e.defaultProps)for(i in p=e.defaultProps,p)r[i]===void 0&&(r[i]=p[i]);return{$$typeof:N,type:e,key:l,ref:d,props:r,_owner:Q.current}}function Ne(e,t){return{$$typeof:N,type:e.type,key:t,ref:e.ref,props:e.props,_owner:e._owner}}function Z(e){return typeof e=="object"&&e!==null&&e.$$typeof===N}function Ae(e){var t={"=":"=0",":":"=2"};return"$"+e.replace(/[=:]/g,function(a){return t[a]})}var oe=/\/+/g;function V(e,t){return typeof e=="object"&&e!==null&&e.key!=null?Ae(""+e.key):t.toString(36)}function U(e,t,a,i,r){var l=typeof e;(l==="undefined"||l==="boolean")&&(e=null);var d=!1;if(e===null)d=!0;else switch(l){case"string":case"number":d=!0;break;case"object":switch(e.$$typeof){case N:case ze:d=!0}}if(d)return d=e,r=r(d),e=i===""?"."+V(d,0):i,te(r)?(a="",e!=null&&(a=e.replace(oe,"$&/")+"/"),U(r,t,a,"",function(f){return f})):r!=null&&(Z(r)&&(r=Ne(r,a+(!r.key||d&&d.key===r.key?"":(""+r.key).replace(oe,"$&/")+"/")+e)),t.push(r)),1;if(d=0,i=i===""?".":i+":",te(e))for(var p=0;p<e.length;p++){l=e[p];var s=i+V(l,p);d+=U(l,t,a,s,r)}else if(s=Ie(e),typeof s=="function")for(e=s.call(e),p=0;!(l=e.next()).done;)l=l.value,s=i+V(l,p++),d+=U(l,t,a,s,r);else if(l==="object")throw t=String(e),Error("Objects are not valid as a React child (found: "+(t==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":t)+"). If you meant to render a collection of children, use an array instead.");return d}function M(e,t,a){if(e==null)return e;var i=[],r=0;return U(e,i,"","",function(l){return t.call(a,l,r++)}),i}function Me(e){if(e._status===-1){var t=e._result;t=t(),t.then(function(a){(e._status===0||e._status===-1)&&(e._status=1,e._result=a)},function(a){(e._status===0||e._status===-1)&&(e._status=2,e._result=a)}),e._status===-1&&(e._status=0,e._result=t)}if(e._status===1)return e._result.default;throw e._result}var h={current:null},O={transition:null},Ee={ReactCurrentDispatcher:h,ReactCurrentBatchConfig:O,ReactCurrentOwner:Q};u.Children={map:M,forEach:function(e,t,a){M(e,function(){t.apply(this,arguments)},a)},count:function(e){var t=0;return M(e,function(){t++}),t},toArray:function(e){return M(e,function(t){return t})||[]},only:function(e){if(!Z(e))throw Error("React.Children.only expected to receive a single React element child.");return e}};u.Component=W;u.Fragment=$e;u.Profiler=Te;u.PureComponent=J;u.StrictMode=Be;u.Suspense=We;u.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Ee;u.cloneElement=function(e,t,a){if(e==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+e+".");var i=ce({},e.props),r=e.key,l=e.ref,d=e._owner;if(t!=null){if(t.ref!==void 0&&(l=t.ref,d=Q.current),t.key!==void 0&&(r=""+t.key),e.type&&e.type.defaultProps)var p=e.type.defaultProps;for(s in t)be.call(t,s)&&!ue.hasOwnProperty(s)&&(i[s]=t[s]===void 0&&p!==void 0?p[s]:t[s])}var s=arguments.length-2;if(s===1)i.children=a;else if(1<s){p=Array(s);for(var f=0;f<s;f++)p[f]=arguments[f+2];i.children=p}return{$$typeof:N,type:e.type,key:r,ref:l,props:i,_owner:d}};u.createContext=function(e){return e={$$typeof:je,_currentValue:e,_currentValue2:e,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},e.Provider={$$typeof:Fe,_context:e},e.Consumer=e};u.createElement=fe;u.createFactory=function(e){var t=fe.bind(null,e);return t.type=e,t};u.createRef=function(){return{current:null}};u.forwardRef=function(e){return{$$typeof:Le,render:e}};u.isValidElement=Z;u.lazy=function(e){return{$$typeof:Re,_payload:{_status:-1,_result:e},_init:Me}};u.memo=function(e,t){return{$$typeof:Pe,type:e,compare:t===void 0?null:t}};u.startTransition=function(e){var t=O.transition;O.transition={};try{e()}finally{O.transition=t}};u.unstable_act=function(){throw Error("act(...) is not supported in production builds of React.")};u.useCallback=function(e,t){return h.current.useCallback(e,t)};u.useContext=function(e){return h.current.useContext(e)};u.useDebugValue=function(){};u.useDeferredValue=function(e){return h.current.useDeferredValue(e)};u.useEffect=function(e,t){return h.current.useEffect(e,t)};u.useId=function(){return h.current.useId()};u.useImperativeHandle=function(e,t,a){return h.current.useImperativeHandle(e,t,a)};u.useInsertionEffect=function(e,t){return h.current.useInsertionEffect(e,t)};u.useLayoutEffect=function(e,t){return h.current.useLayoutEffect(e,t)};u.useMemo=function(e,t){return h.current.useMemo(e,t)};u.useReducer=function(e,t,a){return h.current.useReducer(e,t,a)};u.useRef=function(e){return h.current.useRef(e)};u.useState=function(e){return h.current.useState(e)};u.useSyncExternalStore=function(e,t,a){return h.current.useSyncExternalStore(e,t,a)};u.useTransition=function(){return h.current.useTransition()};u.version="18.2.0";de.exports=u;var I=de.exports;const me=Se(I),Bt=Ce({__proto__:null,default:me},[I]);/**
 * @license React
...
`}function qe(e){return z(e.fontUrl)}function Je(e){const t=(e.buttons||[]).map(P).join("");return`<header class="puck-site-header ${e.headerPosition==="full"?"is-full-width":""}" style="${g({background:e.backgroundColor||"rgba(0,0,0,.72)",borderBottom:e.lineColor?`1px solid ${e.lineColor}`:"none",boxShadow:e.lineShadow||"none",width:e.width||"100%",maxWidth:e.maxWidth||"none",margin:e.margin||"0",padding:e.padding||"22px 40px"})}">
  ...
  </header>`}function Ke(e){const t=e.items||[],a=[...t,...t].map(i=>`<span class="song-name" style="${g({color:e.textColor||"var(--cream)",textShadow:e.textShadow||"none",borderColor:e.buttonBorderColor||"rgba(212, 162, 76, 0.25)"})}">${b(i.text)}</span>`).join("");return`<section class="songs-section puck-song-scroll ${e.stretchMode==="full"?"is-full-width":""}" aria-label="Songs We Play" style="${g({background:e.backgroundColor||"linear-gradient(90deg, var(--blue-deep) 0%, var(--charcoal-light) 50%, var(--blue-deep) 100%)",borderBottom:e.lineColor?`1px solid ${e.lineColor}`:"none",width:e.width||"100%",maxWidth:e.maxWidth||"none",margin:e.margin||"0"})}"><div class="songs-scroll-container"><div class="songs-scroll puck-song-track">${a}</div></div></section>`}function Qe(e){const t=Array.from({length:8}).map(()=>"<span></span>").join(""),a=(e.buttons||[]).map(P).join(""),i=m(e.noThanksText)?`<button class="puck-btn gr-exit-popup-no-thanks" type="button" style="${g({background:e.noThanksBackgroundColor||"transparent",color:e.noThanksTextColor||"#ffffff",border:`1px solid ${e.noThanksBorderColor||"rgba(255,255,255,.45)"}`,borderRadius:"999px",padding:"16px 34px",fontFamily:"Oswald, sans-serif",fontSize:"16px",fontWeight:"700",textTransform:"uppercase",cursor:"pointer"})}">${b(e.noThanksText)}</button>`:"",r=`gr-exit-popup-${Math.random().toString(36).slice(2)}`;return`${z(e.customFontUrl)}
  <style>
  ...
  >
    ...
    <div
      class="gr-welcome-card gr-exit-popup-card gr-theme-${c(e.theme||"toxic")} gr-anim-${c(e.animationStyle||"pop")}"
...
`;export{me as R,Bt as a,q as b,Ct as c,Tt as d,Ve as e,vt as f,Se as g,he as h,o as j,Ft as p,I as r};
